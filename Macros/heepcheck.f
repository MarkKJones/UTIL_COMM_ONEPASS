     ...
     1 sqrt(2.0*am*(e-e1)+am**2-4.0*e*e1*sin(th*radfac/2.0)**2)
      write(6,600)
 600  format(" program heepcheck, version 31.7.99") 
   1  continue
      write(6,601)
 601  format(" enter electron energy(GeV) and angle; E0=0/: stop")     
      read(5,*)e0, the0
      if(e0.lt.0.1)stop
      e0=1000.0*e0
c  internal units are MeV
      call heepkin(e0,the0,pe0,thq0,q0,q2)
      w0=w(e0,pe0,the0)
      write(6,602)e0,the0,pe0,q0,thq0,w0,q2/1.0e6
c
...
c
 ...
 620  format(5f7.1,4f8.2)
      ...
      subroutine heepkin(e,the,pe,thq,q,qq)
      data am/938.30/, radfac/0.017453293/
